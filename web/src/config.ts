export const CONFIG = {
  ...
  detector: { scoreThreshold: 0.4, modelPath: '/models/dfine/' },      // D-FINE-Small (Apache-2.0); Swap = nur der Pfad — rtdetr bleibt als Fallback unter /models/rtdetr/ auf Platte
} as const;
